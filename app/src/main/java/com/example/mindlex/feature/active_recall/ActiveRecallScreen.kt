...
fun ActiveRecallScreen(
    ...
    Column(
        ...
        Box(
            ...
            BookOpenDecorLayer()
            ActiveRecallContent(uiState = uiState, onBackClick = onBackClick, viewModel = viewModel)
        }
...
@Composable
private fun ActiveRecallContent(
    uiState: ActiveRecallViewModel.UiState,
    onBackClick: () -> Unit,
    viewModel: ActiveRecallViewModel
) {
    Column(
